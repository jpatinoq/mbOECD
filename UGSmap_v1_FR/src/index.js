        ...
        const map = new mapboxgl.Map({
            ...
            style: 'mapbox://styles/mkmd/cla9tozob003214q982yzfjbk', //UGS (FR) from OECD mapbox account
            center: [2, 13.5],
            zoom: 4,
        });
        ...
        map.on('mouseenter', 'ugs-centroids', (e) => {
            ...
            const description = 
                ...
                <p style="color:white; font-size: 90%">
                    Espaces verts: ${((e.features[0].properties.UGS_fraction)*100).toFixed(1)}%<br> 
                    PM<sub>2.5</sub> (2019): ${e.features[0].properties.PM25_2019.toFixed(2)} &#13197/m<sup>3</sup><br>
                    Température moyenne: ${e.features[0].properties.annual_mean_temp.toFixed(1)} C<br>
                    Précipitation annuelle: ${e.features[0].properties.annual_precipitation.toFixed(0)} mm<br>
                    Zone agroécologique: ${e.features[0].properties.AEZ_NAME}<br>
