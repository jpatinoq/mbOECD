        ...
        const map = new mapboxgl.Map({
            ...
            style: 'mapbox://styles/mkmd/clbpkzq4x001014qgr5ge4sy9', //Female victims (FR) from OECD mapbox account
            center: [2, 13.5],
            zoom: 4,
        });
        ...
        map.on('mouseenter', 'WA_female_victims_2009_2021', (e) => {
            ...
            const description = 
                `<p style="color:white; font-size: 90%">
                    Victimes: ${e.features[0].properties.FATALITIES}<br>
                    Année: ${e.features[0].properties.YEAR}
                </p>`;
